...
class Staged_VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.num_stage):
            ...
            x = stage(x)
        sequence_0_1 = x
        sequence_0_1 = sequence_0_1.view(sequence_0_1.size()[0], sequence_0_1.size()[1], -1)
        sequence_0_1 = sequence_0_1.sum(dim=0) / sequence_0_1.size()[0]
        x = self.fc(x)  # -> (T, B, num_cls)
        return x.mean(0), sequence_0_1  # -> (B, num_cls)
